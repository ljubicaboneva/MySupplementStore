package mk.ukim.finki.emt.ordermanagement.port.client;
...
@Service
public class SupplementCatalogClient implements RemoteEventLogService {

    private final String source;
    private final String serverUrl;
    private final RestTemplate restTemplate;

    public SupplementCatalogClient(@Value("http://localhost:8081") String serverUrl,
